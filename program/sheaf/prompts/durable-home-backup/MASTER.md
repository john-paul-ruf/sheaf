...
S04/S05/S06 source leases are disjoint but full-session dist:build/playwright:output reservations must serialize under current envelopes. Provider input blockage need not stop S06 once GRAPH-CONTRACT and predecessor proofs are cleared. A distinct port does not isolate shared outputs. After receiving this plan correction, Orchestrator refreshes its ledger from STATE and performs scoped planning-completeness recheck before affected dispatch. DEC-71/72 are approved; save/reminder design is accepted at 4c31ded. Provider design/qualification and demo verdict remain separate gates.

## REPLAN-F05-GRAPH receive and dispatch

Current base `87a4278c7e9918e93158ba58ac7125bef20cca38`: S02 CP1 `03ee571`, CP2 `c7e6507` and partial CP3 `d75830d` are accepted. No implementation recovery remains. Preserve all landed checkpoints. STATE graph map and GRAPH-S02/GRAPH-S06 gates remain authoritative; CP2 current-graph/lifecycle gaps are closed. Resume full CP3 fallback delivery and explicit confirmation, then CP4 J1, after Orchestrator receives this bounded replan and scoped planning-completeness check. Designer save/reminder sources are accepted at `4c31ded`; vault/security source `58bffc8` stays unchanged.

S06 co-owns first nonempty retained/conflict/audit candidate writers, descendant readers, shared publication/frontier/backup-port integration, paired fixtures and J1 assertions at CP1 before CP2 installation. GRAPH-CONTRACT direction is approved; DB/Author must still supply the exact protected format, version and backward-reader contract with compatibility consequences in STATE. S06 and S07's compacted-graph consumption remain blocked until accepted mapping and proofs; independent S02 work may proceed. Do not call current-workbook tests complete nonempty graph proof. Author inputs stay outside every Coder lease. Coder rechecks provisional CA-35/41 at its committed CP1 before CP2 and reports mapping/evidence in Handoff; Orchestrator updates canonical agreements on receive and checks J3/J1 before S07. No mid-session Orchestrator handshake is required. DEC-71/72 and save/reminder design are settled. Provider design/registrations/qualification remain unavailable; approval is no demo verdict.
...
Seven sessions, 28 checkpoint commits: S01 → S02 → S03 → {S04 / S05 / S06; source-disjoint, shared resources serialize} → S07. See explicit dependencies (S04/S05 depend on S01/S02, not S03 code) and current input gates in STATE. First narrow journey J1 is S02 CP4, completed error/recovery proof CP6. S03 integrates reminders/status, S06 compaction/recovery, S07 cloud scheduling/egress. Resume S02 full CP3 after the scoped approval-reconciliation check; S03 follows S02 with approved reminders. Route the exact DB/Author input and provider design/registration gaps to their named owners. Planner does not execute these sessions.
