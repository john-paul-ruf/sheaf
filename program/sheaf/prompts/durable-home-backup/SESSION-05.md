# SESSION-05 — OneDrive App Folder backup transport

> **Program:** Sheaf
> **Feature:** durable-home-backup (F05)
> **Modules:** M26 M56 M62
> **Depends on:** SESSION-01, SESSION-02
> **Concurrent with:** S04, S06
> **Owns:** `src/sync/providers/onedrive/**`, `tests/provider-contract/onedrive/**`, `tests/unit/sync/onedrive/**`
...
> **Resources:** dist:build (live probe), playwright:output (live probe), provider:onedrive:test-account (live only)
> **Checkpoints:** 3
...
| `tests/unit/sync/onedrive/**` | Create (planned) | Behavioral proof/fixture adaptation or owning runner/config mechanism assigned below |
...
**Commit when:** pnpm test tests/unit/sync/onedrive passes, including two-writer race exactly one winner, old generation readable after interruption, stale account cursor rejected, cursor resume not counted as backup.
