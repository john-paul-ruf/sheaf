...
`src/ui/records/records.module.css` positions its sticky search at a literal
...
- 2026-09-08 — F02: consumed by the app area (SESSION-08, `5ab3b07`), which
  recorded the missing top-bar height token above.
- 2026-09-08 — reconciled by Roshi (F01 final pass): rail accessible-name contract
